if (sessionStorage.getItem("type")) {
    ...
    (document.getElementById("agency/name") as HTMLElement).innerText = "Agency Posts";
}
...
(document.getElementById("agency/name") as HTMLElement).innerText = "Your Posts";
function displayPosts(p: any[]) {
    p.forEach(function (i) {
        var _a;
        var card = document.getElementById("to-be-duplicated") as HTMLElement;
        var clone = card.cloneNode(true) as HTMLElement;
...
function deletePost(event: Event) {
    ...
    var tbd =
        (_c =
            (_b =
                (_a = (event.target as HTMLElement).parentElement) === null || _a === void 0
                    ? void 0
